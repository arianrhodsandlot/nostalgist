...
You can open the Devtools here(maybe <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>J</kbd> on Windows/Linux and <kbd>⌘</kbd> + <kbd>⌥</kbd> + <kbd>J</kbd> on macOS) and try Nostalgist.js with global variable `Nostalgist`. No extra setup is required.
