...
<p align="center">
  <a href="https://www.npmjs.com/package/nostalgist" title="nostalgist.js.org" target="_blank" style="display: inline-block; margin: 0 2px;">
...
<p align="center">
  <Image alt="console demo" src={consoleDemo} width="1324" height="532"></Image>
</p>

Open the DevTools of your browser and check out the Console tab, then type these code and type <kbd>Enter</kbd>, an NES emulator will be present in your browser like above (though it's not *Super Mario Bros.* 😐)!
```js
