...
If you want to have a quick try, open the DevTools of your browser(maybe <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>J</kbd> on Windows/Linux and <kbd>⌘</kbd> + <kbd>⌥</kbd> + <kbd>J</kbd> on macOS), then type this code and press <kbd>Enter</kbd>, an NES emulator will appear in your browser like above (though it's not *Super Mario Bros.* 😐)!
