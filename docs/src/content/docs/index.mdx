...
You can also open the DevTools of your browser and check out the Console tab, then type this code and press <kbd>Enter</kbd>. An NES emulator will appear in your browser like above (though it's not *Super Mario Bros.* 😐)!
```js
...
<div>
  ...
  <Card title="Hack" icon="puzzle">
    ...
    <div style="font-size: 12px; margin-top: 4px;">
      Related API:
      [`getEmscriptenFS`](/apis/getEmscriptenFS)
    </div>
  </Card>
</div>
