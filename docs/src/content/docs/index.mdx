...
Open the DevTools of your browser and check out the Console tab, then type this code and press <kbd>Enter</kbd>, an NES emulator will appear in your browser like above (though it's not *Super Mario Bros.* 😐)!
