...
Open the DevTools of your browser(<kbd>Ctrl</kbd>/<kbd>⌘</kbd> + <kbd>Shift</kbd> + <kbd>J</kbd>), then type this code and press <kbd>Enter</kbd>, an NES emulator will appear in your browser like above (though it's not *Super Mario Bros.* 😐)!
