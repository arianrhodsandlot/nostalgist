...
var wasmMemory
var wasmTable = new WebAssembly.Table({ initial: 5610, maximum: 5610 + 0, element: 'anyfunc' })
var ABORT = false
var EXITSTATUS = 0
...
var DYNAMIC_BASE = 9634960,
  DYNAMICTOP_PTR = 4391920
...
function __findEventTarget(target) {
  var domElement =
    __specialEventTargets[target] || (typeof document !== 'undefined' ? document.querySelector(__maybeCStringToJsString(target)) : undefined)
  return domElement
}
...
var ___tm_current = 4391936
var ___tm_timezone = (stringToUTF8('GMT', 4391984, 4), 4391984)
function _tzset() {
