...
await describe('nostalgist', async () => {
  beforeEach(() => {
  ...
  await test('Nostalgist.nes', async (t: TestContext) => {
  ...
  await test('Nostalgist.nes with custom resolveRom', async (t: TestContext) => {
  ...
  await test('Nostalgist.configure with global custom resolveRom', async (t: TestContext) => {
  ...
  await test('Nostalgist.launch with custom core', async (t: TestContext) => {
  ...
  await test('Nostalgist.launch with custom size', async (t: TestContext) => {
  ...
  await test('Nostalgist.launch with custom emscripten core', async (t: TestContext) => {
    const core = {
  ...
  await test('Nostalgist.launch with custom rom and custom emscripten core', async (t: TestContext) => {
    const core = {
      js: 'https://web.libretro.com/fceumm_libretro.js',
      name: 'fceumm',
      wasm: 'https://web.libretro.com/fceumm_libretro.wasm',
  ...
  await test('Nostalgist.launch with multiple files and bios', async (t: TestContext) => {
    const core = {
      js: 'https://web.libretro.com/fceumm_libretro.js',
      name: 'fceumm',
      wasm: 'https://web.libretro.com/fceumm_libretro.wasm',
  ...
  await test('Nostalgist.launch with custom style and size', async (t: TestContext) => {
    const nostalgist = await Nostalgist.launch({
      core: 'fceumm',
      rom: 'flappybird.nes',
  ...
  await test('Nostalgist.launch with shaders', async (t: TestContext) => {
    const nostalgist = await Nostalgist.launch({
      core: 'fceumm',
      rom: 'flappybird.nes',
  ...
  await test('Nostalgist.launch with nested options', async (t: TestContext) => {
    Nostalgist.configure({
      retroarchConfig: {
        input_audio_mute: 'a',
  ...
  await test('Nostalgist.launch overwrites the configured core', async (t: TestContext) => {
  ...
  await test('Nostalgist.launch overwrites the configured custom emscripten core', async (t: TestContext) => {
    const core = {
      js: 'https://web.libretro.com/fceumm_libretro.js',
      name: 'fceumm',
      wasm: 'https://web.libretro.com/fceumm_libretro.wasm',
  ...
  await test('Nostalgist.launch with a custom element', async (t: TestContext) => {
  ...
  await test('Nostalgist[shortcut] with blob', async (t: TestContext) => {
